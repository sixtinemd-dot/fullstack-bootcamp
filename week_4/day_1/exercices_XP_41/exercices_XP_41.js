...
// It will console.log : I am John Doe from Vancouver, Canada. Latitude(49.2827), Longitude(-123.1207)
...
console.log(displayStudentInfo('Elie', 'Schoppik'))
...
// IT is going to console.log : "object" because member is an object of the Person class.
...
}; // This one will successfully extend the Dog class because it calls "super()"" and then uses "this.""
...
class Mammal extends Animal {
    sound(sound) {
        return `Animal's name: ${this.name}, type: ${this.type}, color :${this.color} and sound: ${sound}.`
    }
}
